...
def preprocess_4_flair(FIN="filteredtweets/allfilteredtweets.csv", FOUT="filteredtweets/preprocessed_tweets.csv"):
    '''takes a csv from outputted by the json_2_csv_script.py,
...
# FOUT = "filtered/preprocessed_tweets.csv"
# ##########################
