...
def join_flair_2_json(POS_FIN='flair/pos_tweets.json', NER_FIN='flair/ner_tweets.json', SENT_FIN='flair/sentiment_tweets.json', FOUT='flair/'):
    ...
    def main(POS_FIN, NER_FIN, SENT_FIN, FOUT):
    ...
    main(POS_FIN, NER_FIN, SENT_FIN, FOUT)


# ##### EXAMPLE ############
# # HYPERPARAMETERS ########
# POS_FIN = 'flair/pos_tweets.json'
# NER_FIN = 'flair/ner_tweets.json'
# SENT_FIN = 'flair/sentiment_tweets.json'
# FOUT = 'flair/'
# ##########################
